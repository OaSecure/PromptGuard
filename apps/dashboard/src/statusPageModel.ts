...
export type ExtensionConnectionInfo = {
  ...
  api_port: string;
  extension_api_url: string | null;
  extension_api_url_status: "configured" | "missing" | "invalid";
  extension_api_url_error: string | null;
...
function extensionApiUrlValue(connection: ExtensionConnectionInfo): string {
...
function extensionApiUrlDescription(connection: ExtensionConnectionInfo): string {
  if (connection.extension_api_url_status === "configured" && connection.extension_api_url) {
...
function extensionApiUrlState(connection: ExtensionConnectionInfo): "ready" | "warning" | "error" {
  return connection.extension_api_url_status === "configured" ? "ready" : "error";
}

function dashboardPublicUrlValue(connection: ExtensionConnectionInfo): string {
