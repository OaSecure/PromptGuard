...
def upgrade() -> None:
    ...
    op.create_index("ix_dashboard_sessions_user_expires_at", "dashboard_sessions", ["user_id", "expires_at"])


def downgrade() -> None:
    op.drop_index("ix_dashboard_sessions_user_expires_at", table_name="dashboard_sessions")
