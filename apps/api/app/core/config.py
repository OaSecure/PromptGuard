...
class Settings(BaseSettings):
    ...
    initial_admin_password: str = Field(default="1234", alias="PROMPTGUARD_INITIAL_ADMIN_PASSWORD")
    ...
    refresh_idle_timeout_days: int = Field(default=14, alias="REFRESH_IDLE_TIMEOUT_DAYS")
