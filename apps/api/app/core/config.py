...
class Settings(BaseSettings):
    ...
    dashboard_session_secret: str = Field(default="change-me-dashboard-session-secret", alias="DASHBOARD_SESSION_SECRET")
    ...
    dashboard_session_ttl_hours: int = Field(default=12, alias="DASHBOARD_SESSION_TTL_HOURS")
