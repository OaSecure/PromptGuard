...
class AnalysisEvent(Base):
    ...
    context_risk_evidence: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True)
...
class EventInput(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "decision_basis in ('no_detection', 'detection', 'content_unavailable', 'metadata_only', 'context_risk')",
